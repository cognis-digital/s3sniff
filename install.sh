#!/usr/bin/env sh
# Universal installer for s3sniff. Prefers uv > pipx > pip; installs from the repo.
set -e
SRC="git+https://github.com/cognis-digital/s3sniff.git"
echo "Installing s3sniff ..."
