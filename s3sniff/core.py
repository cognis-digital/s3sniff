"""S3SNIFF core — Flag risky cloud-bucket ACLs/policies from a listing or policy JSON."""
...
RULES = [
    ("S3S-001", "high", "TODO", "Unresolved TODO / placeholder left in input", "Resolve before shipping."),
    ("S3S-002", "medium", "FIXME", "FIXME marker found", "Address the flagged issue."),
    ("S3S-003", "low", "XXX", "XXX marker found", "Review the flagged section."),
]
