"""S3SNIFF command-line interface."""
from __future__ import annotations
import argparse, sys
from s3sniff.core import scan, to_json, TOOL_NAME, TOOL_VERSION

def main(argv=None) -> int:
    ap = argparse.ArgumentParser(prog="s3sniff", description="S3SNIFF — Cognis Neural Suite")
    ...
    if args.cmd == "mcp":
        from s3sniff.mcp_server import serve
        return serve()
    if args.cmd == "scan":
