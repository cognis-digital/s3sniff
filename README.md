...
[![PyPI](https://img.shields.io/pypi/v/cognis-s3sniff.svg?color=6b46c1)](https://pypi.org/project/cognis-s3sniff/) [![CI](https://github.com/cognis-digital/s3sniff/actions/workflows/ci.yml/badge.svg)](https://github.com/cognis-digital/s3sniff/actions) [![License: COCL 1.0](https://img.shields.io/badge/License-COCL%201.0-2b6cb0.svg)](LICENSE) [![Suite](https://img.shields.io/badge/Cognis-Neural%20Suite-6b46c1.svg)](https://github.com/cognis-digital)
...
```mermaid
flowchart LR
  IN[target / manifest] --> P[s3sniff<br/>checks + rules]
